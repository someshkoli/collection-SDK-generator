const sdk = require('postman-collection');
	...
	// lib = require('./lib')
// console.log(start(__dirname+'/test/unit/fixtures/sample_collection.json','nodejs-request'));
...
// var a=jso(__dirname+'/test/unit/fixtures/sample_collection.json','nodejs-request', (err,data)=>{
// 	console.log(data);
// });
// console.log(a);
start(__dirname+'/test/unit/fixtures/sample_collection.json','nodejs-request');

// console.log(coll.items.members)
console.log(a);